...
See https://docs.swmansion.com/react-native-worklets/docs/guides/troubleshooting#native-part-of-worklets-doesnt-seem-to-be-initialized for more details.`);
  ...
  createSerializableNonWorkletFunction(fun, functionId, functionName) {
    return this.#workletsModuleProxy.createSerializableNonWorkletFunction(fun, functionId, functionName);
  }
