...
export function setupConsoleForwarding(boundCapturableConsole) {
  'worklet';

  globalThis.nativeLoggingHook = (message, level) => {
    switch (level) {
      case 0:
...
function installRNBindingsOnUIRuntime() {
  if (!WorkletsModule) {
    throw new Error('[Worklets] Worklets are trying to initialize the UI runtime without a valid WorkletsModule');
  }
